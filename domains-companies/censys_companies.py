...
class Module(BaseModule):
    ...
    def module_run(self, domains):
        ...
        IPV4_FIELDS = [
            ...
            '995.pop3s.tls.tls.certificate.parsed.subject.organization',
            '143.imap.starttls.tls.certificate.parsed.subject.organization',
            ...
            '631.ipp.banner.tls.certificate.parsed.subject.organization',
            '1433.mssql.banner.tls.certificate.parsed.subject.organization',
            ...
            '5672.amqp.banner.tls.certificate.parsed.subject.organization',
            '1883.mqtt.banner.tls.certificate.parsed.subject.organization',
            '8883.mqtt.banner.tls.certificate.parsed.subject.organization',
            '9200.elasticsearch.banner.tls.certificate.parsed.subject.organization',
        ]
        SEARCH_FIELDS = [
